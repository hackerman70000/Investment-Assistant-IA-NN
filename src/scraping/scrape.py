...
class Scraper:
    ...
    def __init__(self, symbol: str = "BTCUSDT", interval: str = "1d", start_date: datetime = EARLIEST_DATE, end_date: Optional[datetime] = None, directory: str = "data", verify_checksum: bool = False):
...
def parse_arguments() -> argparse.Namespace:
    ...
    parser.add_argument("--directory", type=str, default="data", help="Directory to save data")
